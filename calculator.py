...
def draw_text_field(text_param):
    ...
    text_view = screen.create_text(init_button_x + button_size, init_button_y+button_size*5,font = "Arial 28", text = text_param, fill = "black")
...
text_view = screen.create_text(init_button_x+button_size,init_button_y+button_size*5,font = "Arial 28",text = text_to_parse, fill = "yellow")
